...
btnZ = Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_Z,width=10,height=3,text='Z',bg='orange',fg='white')\
    .grid(row=4,column=5)
btnClear = Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=clear,width=10,height=3,text='Clear',bg='white',fg='black')\
    .grid(row=4,column=6)
